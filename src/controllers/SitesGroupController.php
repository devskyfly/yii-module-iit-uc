...
use devskyfly\yiiModuleIitUc\models\siteGroup\SiteGroup;
use devskyfly\yiiModuleIitUc\models\siteGroup\SiteGroupFilter;
use devskyfly\yiiModuleIitUc\models\siteGroup\SiteGroupToSiteBinder;

class SitesGroupController extends AbstractContentPanelController
{
    /**
     *
     * {@inheritDoc}
    ...
    public function entityEditorViews()
    {
        ...
        {
            $site_group_to_rate_binder = SiteGroupToSiteBinder::class;
            return [
                [
                    "label"=>"main",
                    "content"=>
                    ...
                    .Binder::widget([
                        ...
                        "form"=>$form,
                        "master_item"=>$item,
                        "binder_cls"=>$site_group_to_rate_binder
                    ])
                ]
            ];
        };
